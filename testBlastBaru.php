					...
					<tr>
						...
						<table align="center" border="0" cellpadding="0" cellspacing="0" class="scale" style="width:600px; background-color: white;">
							<tbody>
								...
								<tr>
									<td style="text-align:center; width:100%"><img alt="creasi-poster" src="https://s3-ap-southeast-1.amazonaws.com/creasi/production/files/1KnwSkM976df3pVWFCG6.jpg" style="height:250px; width:550px" /></td>
								</tr>
							</tbody>
						</table>
						</td>
								...
								<tr>
                                    <td>
                                        <div class="" style="padding: 20px 40px 40px; font-size: 14px;">
                                            <p>Eits&hellip; jangan lupa loh.. kamu juga berkesempatan memenangkan hadiah voucher dengan total nilai lebih dari Rp 4.000.000,-. Cari tahu cara memenangkan hadiah nya <a href="http://omb.creasi.co.id" target="_blank">disini</a><br />
                                            <br />
                                            Tunggu apa lagi?? Ayoo apply lowongannya sekarang juga.</p>
                                        </div>
									</td>
								</tr>
							</tbody>
