								...
								<tr>
									...
									<div style="padding-top: 30px;">
                                        <h2 align="center" style="text-align: center; font-weight:700 !important; font-size:27px !important; color:#222 !important; font-family:'Proxima N W01 At Smbd', Helvetica, Arial, sans-serif; letter-spacing: 2px !important; line-height:1.5 !important; padding-bottom: 15px; !important">
										 3 hari lagi  <span style="color:#D02027">Online Magang Ber-Creasi </span> <br />
                                         untuk mahasiswa/i DKV & Ilmu komunikasi akan dimulai
										</h2>
									</div>
									</td>
								</tr>
								...
								<tr>
									<td>
                                        <div style="padding: 0 40px; font-size: 14px; text-align: justify;">
                                            ...
                                            Hi Creative Talent!!
                                            <br />
                                            Tiga hari lagi <b>OMB (Online Magang Ber-Creasi)</b> akan segera dimulai loh!! <br />
                                            Untuk kamu mahasiswa/i jurusan DKV dan Ilmu Komunikasi yang sedang mencari tempat magang pastikan kamu sudah upload CV & Portfolio keren kamu di <a style="color:#D02027" href="https://www.creasi.co.id/" target="_blank">creasi.co.id</a> yah. 
                                            <br /><br />
                                            </p>
                                        </div>
									</td>
							...
							<tbody>
								<tr>
									...
									<div style="padding: 20px 40px 40px; font-size: 14px;">
                                        <br />
                                        <p>Masih bingung untuk membuat CV yang menarik perhatian HRD untuk membuat mereka impressed dengan karya – karya mu? 
                                            Langsung aja <a href="https://www.creasi.co.id/readings/145/cara-membuat-cv-yang-efektif-dan-menarik-10-template-cv-gratis" target="_blank">klik di sini</a> untuk medapatkan tips cara membuat CV yang efektif dan menarik + 10 template CV gratis buat kamu ^^
                                        </p>
                                        <br />
                                    </div>
									</td>
