					...
					<tr>
						...
						<table align="center" border="0" cellpadding="0" cellspacing="0" class="scale" style="background-color:white; width:600px">
							<tbody>
									...
									<td>
                                        <div style="padding: 0 40px; font-size: 15px;">
                                            <div style="text-align: justify; font-family: Arial;">
                                                ...
                                                Selamat Tahun Baru!
                                                <br /><br />
                                                Untuk mengawali tahun ini, izinkan kami berterimakasih atas semua partisipasi kamu di Creasi selama tahun 2017 lalu.
                                                <br /><br />
								...
								<tr>
									<td style="text-align:center; width:100%"><img alt="creasi-poster" src="https://s3-ap-southeast-1.amazonaws.com/creasi/production/files/n5MsZIV.jpg" style="width:550px" /></td>
								</tr>
							</tbody>
						</table>
						</td>
