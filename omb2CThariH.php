								...
								<tr>
									...
									<div style="padding-top: 30px;">
                                        <h2 align="center" style="text-align: center; font-weight:700 !important; font-size:27px !important; color:#222 !important; font-family:'Proxima N W01 At Smbd', Helvetica, Arial, sans-serif; letter-spacing: 2px !important; line-height:1.5 !important; padding-bottom: 15px; !important">
										 Apply lowongan magang sekarang juga <br />
                                         karena <span style="color:#D02027">Online Magang Ber-Creasi</span> sudah dimulai hari ini!!
										</h2>
									</div>
									</td>
								</tr>
								...
								<tr>
									<td>
                                        <div style="padding: 0 40px; font-size: 14px; text-align: justify;">
                                            ...
                                            Hi Creative Talent!!
                                            <br />
                                            Hari ini <b>OMB</b> sudah dimulai loh… <br />
                                            Untuk kamu mahasiswa/i jurusan DKV & Ilmu Komunikasi yang sedang mencari tempat magang, 
                                            ayo segera apply lowongan magang dari perusahaan – perusahaan keren yang sudah berpartisipasi di OMB (Online Magang Ber-Creasi).
                                            <br /><br />
                                            </p>
                                        </div>
									</td>
								...
								<tr>
									<td>
                                        <div style="padding: 20px 40px 40px; font-size: 14px;">
                                            <br />
                                            <p>Tunggu apa lagi? Ayo apply lowongannya sekarang juga. </p>
                                            <br />
                                        </div>
									</td>
								</tr>
