...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="width:100%">
	<tbody>
		<tr>
			<td style="background-color:#eceff3"><!-- Navigation -->
					...
					<tr>
						...
						<table align="center" border="0" cellpadding="0" cellspacing="0" class="table600" style="background-color:#222222; background-position:top; background-size:cover; border-bottom:5px solid #e0e5eb; border-top-left-radius:6px; border-top-right-radius:6px; width:600px">
							<tbody>
								...
								<tr>
									<td>
									<div style="color:white; text-align:center; padding-bottom: 15px;">
									<p>Website-nya orang kreatif mencari kerja</p>
									</div>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<div style="padding-top: 30px;">
                                        <h2 align="center" style="text-align: center; font-weight:700 !important; font-size:27px !important; color:#222 !important; font-family:'Proxima N W01 At Smbd', Helvetica, Arial, sans-serif; letter-spacing: 2px !important; line-height:1.5 !important; padding-bottom: 15px; !important">
										 Rekrut Pekerja Magang <span style="color:#D02027">Gratis </span> <br />
                                         di <span style="color:#D02027">OMB</span> - Online Magang Ber-Creasi
										</h2>
									</div>
									</td>
								</tr>
							...
							<tbody>
								<tr>
									<td>
                                        <div style="padding: 0 40px; font-size: 14px; text-align: justify;">
                                            ...
                                            Hi Talent Seekers!,
                                            <br /><br />
                                            Apakah perusahaan Anda sedang mencari <span style="color:#D02027">PEKERJA MAGANG</span> untuk posisi graphic designer, web designer, account executive, copywriter, social media officer, content writer, video editor, photographer, marketing communication, public relation atau pekerja kreatif lainnya?  
                                            <br /><br />
                                            Kirim lowongan kerja perusahaan Anda untuk berpartisipasi dalam acara <span style="color:#D02027"><b>OMB - Online Magang Ber-Creasi</b></span> secara <b>GRATIS</b> dan dapatkan puluhan pelamar yang berkualitas karena kami sudah bekerjasama dengan lebih dari 40 kampus di Indonesia.
                                            <br /><br />
                                            </p>
                                        </div>
									</td>
                                ...
                                <tr>                                  
                                    <td  style="padding: 0 30px;">
                                        <img src="https://s3-ap-southeast-1.amazonaws.com/creasi/production/files/wmNTbm6R.jpg" width="525" alt="" border="0" class="hover">
                                    </td>
                                </tr>
							</tbody>
						</table>
							...
							<tbody>
								<tr>
									...
									<div style="padding: 20px 40px 40px; font-size: 14px;">
                                        <br />
                                        <p><span style="color:#D02027">OMB - Online Magang Ber-creasi</span> adalah <b>online job fair khusus lowker magang yang diselenggarakan oleh Creasi.co.id</b> untuk membantu mahasiswa/i DKV & Ilmu Komunikasi dalam mencari dan mendapatkan tempat magang yang sesuai.</p>
                                        <br /><br />
                                        <b>Kenapa perusahaan Anda harus ikut serta?</b>
                                        <br /><br />
                                        <ul style="padding-left: 20px;">
                                            <li>Selama periode OMB dari 1-31 Mei 2018, semua pemasangan iklan lowongan kerja untuk posisi magang <b>GRATIS.</b></li>
                                            <li>Talent Seekers (Perusahaan) bisa posting lowker magang di OMB lebih dari 1 posisi (unlimited), sesuai kebutuhan.</li>
                                            <li>Brand perusahaan semakin dikenal di kalangan akademis</li>
                                        </ul>
                                        <br /><br />
                                        <p style="text-align: center;">Daftarkan perusahaan Anda untuk ikut serta dengan cara menghubungi Customer Relations Officer kami: <br />
