					...
					<tr>
						...
						<table align="center" border="0" cellpadding="0" cellspacing="0" class="scale" style="background-color:white; width:600px">
							<tbody>
									...
									<td>
                                        <div style="padding: 0 40px; font-size: 16px;">
                                            <div style="text-align: justify; font-family: Arial;">
                                                ...
                                                <br /><br />
                                                Semua team Creasi libur mulai 26 Desember 2017 dan akan aktif bekerja kembali pada 2 Januari 2018 nanti. Sampai jumpa tahun depan! Selamat liburan!
                                                <br /><br />
								...
								<tr>
									<td style="text-align:center; width:100%"><img alt="creasi-poster" src="https://s3-ap-southeast-1.amazonaws.com/creasi/production/files/XlunW6MvegU72br0qLVL79V5.jpg" style="width:550px" /></td>
								</tr>
							</tbody>
						</table>
						</td>
					...
					<tr>
						...
						<table align="center" border="0" cellpadding="0" cellspacing="0" class="scale" style="background-color:white; width:600px">
							<tbody>
								<tr>
									<td>
                                        <div style="padding: 20px 40px; font-size: 14px; font-family: arial; text-align: center;">
					...
					<tr>
						...
						<table align="center" border="0" cellpadding="0" cellspacing="0" class="scale" style="background-color:white; padding-bottom:50px; width:600px">
							<tbody>
								<tr>
									<td>
									<div style="padding: 10px; color: grey; font-size: 14px; text-align: center;">
                                        <p>&nbsp;</p>
                                    </div>
									</td>
								</tr>
